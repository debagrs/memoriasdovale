...
const igrejaCorpusDominiSinos = '/audio/igreja-corpus-domini-sinos.mp3';
const casaParoquialEncontro = '/audio/casa-paroquial-encontro.mp3';
const casaraoMuseusMadeira = '/audio/casarao-museus-madeira.mp3';
const grutaLourdesAgua = '/audio/gruta-lourdes-agua.mp3';
const festivalEnsaiosInverno = '/audio/festival-ensaios-inverno.mp3';
const miranteCerroVentoPinhais = '/audio/mirante-cerro-vento-pinhais.mp3';
const piazzaEntardecerPassaros = '/audio/piazza-entardecer-passaros.mp3';
